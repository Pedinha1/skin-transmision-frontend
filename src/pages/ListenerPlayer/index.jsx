        ...
        try {
          ...
          if (broadcasterData.directStream || broadcasterData.streaming) {
            ...
            if (audioRef.current) {
              ...
              // Não definir src como vazio - isso causa erro
              // Vamos definir o MediaSource diretamente
                ...
                if (MediaSource.isTypeSupported(mimeType)) {
                  ...
                  mediaSource.addEventListener('sourceopen', () => {
                    try {
                      ...
                      console.log('✅ MediaSource aberto, pronto para receber chunks');
                      ...
                      // Handler para receber chunks de áudio
                      const audioChunkHandler = (chunkData) => {
                        try {
                          if (chunkData.data && sourceBuffer) {
                            ...
                            if (sourceBuffer.readyState === 'open') {
                              ...
                              // Iniciar reprodução quando tiver dados
                      ...
                      console.log('✅ Preparado para receber chunks de áudio via Socket.IO');
                    } catch (error) {
